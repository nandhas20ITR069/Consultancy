...
const NavBar = () => {
    ...
    return (
        <div className="flex justify-between items-center flex-wrap h-42 relative text-green-400 bg-gray-700">
            ...
            <div className="text-dark flex justify-between items-center h-24 w-4/5 max-w-[1240px] ">
                ...
                <Link to="/"><h1 className="w-full text-2xl md:text-4xl  font-bold font-poppins tracking-wide text-white "> Vinayaga Agency </h1></Link>
                ...
                <div className={nav ? 'z-10 fixed left-0 top-0 w-[60%] h-full border-r border-r-gray-900 bg-[#000300] ease-in-out duration-500 text-green-400	' : 'fixed left-[-100%]'}>
                    <h1 className="w-full text-2xl font-bold m-2 font-poppins "> <b>Vinayaga Agency</b> </h1>
