...
export default function Footer() {
  return <footer
        class="z-20 text-center text-green-400 bg-gray-700 lg:text-left"> 
        {/* <div      bg-green-200	
        ...
        <div class="mx-6 py-10 text-center md:text-left">
          <div class="grid-1 grid gap-8 md:grid-cols-2 lg:grid-cols-4">
            ...
            <div class="">
              ...
              <p class="mb-4">
                <a href="#!" class="text-slate-100	"> <Link to='/'>Home</Link> </a>
              </p>
              <p class="mb-4">
                <a href="#!" class="text-slate-100	"><Link to='/productlist'>Product List</Link> </a >
              </p>
          ...
          >
            ...
            <div class="">
              ...
              <p class="mb-4">
                <a href="#!" class="text-slate-100"><Link to='/'>About Us</Link> </a >
              </p>
              <p class="mb-4">
                <a href="#!" class="text-slate-100	"><Link to='/cart'>My Cart</Link> </a>
              </p>
              {/* <p class="mb-4">
                <a href="#!" class="text-slate-100	"><Link to='/productlist'>Contact</Link> </a>
              </p> */}
